            ...
            <div className="experience--section--container">
                <div class="about--containers">
                    <div class="inner--about">
                        <a href="https://www.mediaworks.co.uk/" target="_blank"  class="details--container">
                            <div>
                                <img src="./img/coding.png" alt="Experience icon" class="icon icon-lg mb-2"/>
                                <p class="mb-2">Web Developer</p>
                                <h2 class="experience--sub--title">Mediaworks</h2>
                                <div class="article--container">
                                    <p>
                                        At Mediaworks, I develop and maintain high-traffic .NET/Umbraco websites, focusing on responsive UI, accessibility, and clean component-based design using Tailwind CSS. I translate designs into scalable front-end solutions and build back-end features that support reliable user experiences across Citizen Housing and West Yorkshire Combined Authority platforms.
                                    </p>
                                    <p>
                                        Alongside feature development, I contribute to our delivery workflows by improving Azure DevOps pipelines, supporting smoother deployments and more consistent release cycles. My work balances technical quality with client needs, collaborating closely with designers and stakeholders to deliver polished, user-focused digital products.
                                    </p>
                                </div>
                            </div>
                            <div>
                                ...
                                <ul className="code-icons icons-lg">
                                    ...
                                    <li><i class="devicon-azure-plain"></i></li>
